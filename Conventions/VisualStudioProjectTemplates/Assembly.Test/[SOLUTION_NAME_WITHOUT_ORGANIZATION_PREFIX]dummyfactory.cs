// --------------------------------------------------------------------------------------------------------------------
// <copyright file="[SOLUTION_NAME_WITHOUT_ORGANIZATION_PREFIX]DummyFactory.cs" company="OBeautifulCode">
...
#endif
    public class [SOLUTION_NAME_WITHOUT_ORGANIZATION_PREFIX]DummyFactory : Default[SOLUTION_NAME_WITHOUT_ORGANIZATION_PREFIX]DummyFactory
    {
        public [SOLUTION_NAME_WITHOUT_ORGANIZATION_PREFIX]()
        {
